            ...
            <div class="card shadow-sm border-0" style="border-radius: 16px;">
                ...
                <div class="card-header border-bottom bg-white d-flex justify-content-between align-items-center py-3" style="border-radius: 16px 16px 0 0;">
                    <h5 class="mb-0 fw-bold" style="color: var(--squid-secondary);">
                        <i class='bx bx-plus-circle me-2'></i>Buat Misi Baru
                    </h5>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.challenges.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" class="form-control" placeholder="Contoh: Logika Algoritma Dasar" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-2">
                                <div class="col-4 difficulty-selector">
                                    <input type="radio" name="price" id="tier1" value="300000" class="form-check-input" checked>
                                ...
                                <div class="col-4 difficulty-selector">
                                    <input type="radio" name="price" id="tier2" value="500000" class="form-check-input">
                                ...
                                <div class="col-4 difficulty-selector">
                                    <input type="radio" name="price" id="tier3" value="700000" class="form-check-input">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" class="form-control" rows="5" placeholder="Jelaskan detail misi di sini..." required></textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="upload-box" onclick="document.getElementById('file_pdf').click()">
                                ...
                                <p class="small text-muted mb-0">Klik area ini untuk upload file soal (Max 2MB)</p>
                        ...
                        <div class="d-grid pt-2">
                            <button type="submit" class="btn btn-primary fw-bold py-2" style="background-color: var(--squid-primary); border: none; border-radius: 8px;">
                                <i class='bx bx-save me-1'></i> Simpan Misi
                            </button>
                        </div>
