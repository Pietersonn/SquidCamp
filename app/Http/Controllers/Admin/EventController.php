...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $event = Event::create([
            ...
            'is_finished' => 0, // Default belum selesai
        ]);
    ...
    public function show(Event $event)
    {
        ...
        // Leaderboard kelompok berdasarkan TOTAL WEALTH (Bank + Cash)
        $leaderboardGroups = $event->groups()
            ->withCount('members')
            ->selectRaw('groups.*, (squid_dollar + bank_balance) as total_wealth')
    ...
    // =========================================================================
    // BUTTON ACTIONS (LOGIKA BARU)
    // =========================================================================

    /**
     * Memulai Event (Set Active = True, Finished = False)
     */
    public function startEvent(Event $event)
    {
        ...
        return back()->with('success', 'Event Berhasil Dimulai! Peserta sekarang bisa masuk.');
    }

    /**
     * Menyelesaikan Event (Set Active = False, Finished = True)
     */
    public function finishEvent(Event $event)
    {
        ...
        return back()->with('success', 'Event Ditutup! Semua peserta diarahkan ke halaman Thanks.');
    }
}
