...
class EventController extends Controller
{
  ...
  public function show(Event $event)
  {
    ...
    // [UPDATED] Ambil leaderboard kelompok berdasarkan TOTAL WEALTH (Bank + Cash)
    // Kita gunakan selectRaw untuk menjumlahkan kolom squid_dollar dan bank_balance
    $leaderboardGroups = $event->groups()
      ->withCount('members')
      ->selectRaw('groups.*, (squid_dollar + bank_balance) as total_wealth') // Hitung Total
      ->orderByDesc('total_wealth') // Urutkan dari total terbanyak
